(this.nativeLog || function(s) {console.log(s)})('START JS FRAMEWORK 0.23.4-beta.1, Build 2017-11-29 15:41.');
(this.getJSFMVersion = function(){return "0.23.4-beta.1"});var global = this, process = { env: {} };var setTimeout = global.setTimeout;
...
var subversion = {"browser":"0.5.0","framework":"0.23.4-beta.1","vue-render":"0.12.24","transformer":">=0.1.5 <0.5"};
...
var runtime = {
  ...
  service: { register: register$2, unregister: unregister, has: has$1 },
